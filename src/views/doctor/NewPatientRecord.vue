                ...
                <div class="app-form-group buttons">
                  <vs-row>
                    <vs-col
                      ...
                      w="5"
                    >
                      <vs-button size="large" @click="createNewRecord">
                        Submit
                      </vs-button>
                      <vs-button class="ml-5" size="large" @click="goBack"> Back </vs-button>
                    </vs-col>
                  </vs-row>
                </div>
              </div>
...
export default {
  ...
  methods: {
    danger() {
      this.$buefy.toast.open({
        duration: 5000,
        message: `Could not encrypt and share the record, please try again later.`,
        position: "is-bottom",
        type: "is-danger",
      });
    },
    success() {
      this.$buefy.toast.open({
        duration: 2000,
        message: `Successfully created and stored the new record.`,
        position: "is-bottom",
        type: "is-success",
      });
    },
    async createNewRecord() {
      ...
      this.isLoading = true;
      this.$store
        .dispatch("doctor/createSignShareNewRecord", {
  ...
  created() {
    this.record.doctor = this.profile.name ?? ""
  }
};
</script>
<style scoped>

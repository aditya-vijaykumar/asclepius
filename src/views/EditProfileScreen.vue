                    ...
                    <div class="screen-body">
                        ...
                        <div class="screen-body-item">
                            ...
                            <div class="app-form">
                                ...
                                <div class="app-form-group">
                                    <input class="app-form-control" placeholder="Residence"
                                        v-model="profile.homeLocation" />
                                </div>
                                <div class="app-form-group">
                                    <input class="app-form-control" placeholder="Birthdate" v-model="profile.birthDate"
                                        type="date" />
                                </div>
                                <div class="app-form-group">
                                    <textarea class="app-form-control" placeholder="Bio" name="description" cols="30"
                                        rows="5" v-model="profile.description"></textarea>
                                </div>
                                <div class="app-form-group">
                                    <input class="app-form-control" placeholder="Profile Image" type="file"
                                        accept="image/*" id="profileImage" name="profileImage" @change="updateImage" />
                                </div>
                                <div class="app-form-group buttons">
                                    ...
                                    <button class="app-form-button" @click="updateProfile">
                                        SUBMIT
                                    </button>
                                </div>
                            </div>
